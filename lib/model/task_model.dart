class Task {
  ...
  // Constructor
  Task({this.id, DateTime this.date, this.taskName, this.isDone = false});

  Map<String, dynamic> toMap() {
    return {'id': id, 'date': date, 'taskName': taskName, 'isDone': isDone};
  }
  ...
  Map<String, dynamic> toJson() =>
      {"id": id, "date": date, "taskName": taskName, "isDone": isDone};
